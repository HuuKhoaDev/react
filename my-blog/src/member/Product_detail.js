    ...
    useEffect(() => {
      api.get('product/detail/' + params.id)
        .then(response => {
          ...
          setPr_ImgBig(images[0]);
          setPr_ImgSlide(images);
        })
        .catch(function (error) {
          console.log(error);
        });
          ...
          <div className="product-details">
            <div className="col-sm-5">
              <div className="view-product">
                <img src={"http://localhost/laravel8/laravel8/public/upload/product/" + getUser + '/' + getPr_ImgBig} alt="" />
                ...
                <div className="carousel-inner">
                  <div className="item active">
                    {getPr_ImgSlide.map((value, key) => {
                      return (
                        <a href="#" key={key}><img onClick={toto} width="90px" src={"http://localhost/laravel8/laravel8/public/upload/product/" + getUser + '/' + value} alt="" /></a>
                      );
                    })}
                  </div>
                </div>
              ...
              <div className="product-information">
                ...
                {getStatus.map((value, key) => {
                  if (value.id === getProduct_detail.status) {
                    return (
                      <p key={key}><b>Condition:</b> {value.name}</p>
                    );
                  }
                })}
                {getCategory.map((value, key) => {
                  if (value.id === getProduct_detail.id_brand) {
                    return (
                      <p key={key}><b>Brand:</b> {value.category}</p>
                    );
                  }
                })}
              ...
              <div className="category-tab shop-details-tab">
                  ...
                  <div className="tab-content">
                    <div className="tab-pane fade" id="details">
                      ...
                      <div className="col-sm-3">
                        <div className="product-image-wrapper">
                          <div className="single-products"><div className="productinfo text-center">
                      ...
                      <div className="col-sm-3">
                        <div className="product-image-wrapper">
                          <div className="single-products">
                            <div className="productinfo text-center">
                              <img src="images/home/gallery4.jpg" alt="" />
                              <h2>$56</h2><p>Easy Polo Black Edition</p>
                              <button type="button" className="btn btn-default add-to-cart"><i className="fa fa-shopping-cart" />Add to cart</button>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="product-image-wrapper">
                          <div className="single-products">
                            <div className="productinfo text-center">
                              ...
                              <h2>$56</h2>
                              <p>Easy Polo Black Edition</p>
                              <button type="button" className="btn btn-default add-to-cart"><i className="fa fa-shopping-cart" />Add to cart</button></div>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="carousel-inner">
                      <div className="item active">	
                        ...
                        <div className="col-sm-4">
                          <div className="product-image-wrapper">
                            <div className="single-products">
                              <div className="productinfo text-center"><img src="images/home/recommend2.jpg" alt="" />
                                <h2>$56</h2>
                                <p>Easy Polo Black Edition</p>
                                <button type="button" className="btn btn-default add-to-cart"><i className="fa fa-shopping-cart" />Add to cart</button>
                              </div>
